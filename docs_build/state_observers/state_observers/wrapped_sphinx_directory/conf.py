...
exec(open("/home/kalman/projects/turtlebot_ws/src/state_observers/docs_build/state_observers/state_observers/default_sphinx_project/conf.py").read())
...
ensure_global('project', "state_observers")
ensure_global('author', """kalman""")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['rclcpp', 'std_msgs', 'eigen']:
        try:
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "state_observers Doxygen Project": "/home/kalman/projects/turtlebot_ws/src/state_observers/docs_build/state_observers/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/kalman/projects/turtlebot_ws/src/state_observers/docs_build/state_observers/state_observers/wrapped_sphinx_directory/generated",
